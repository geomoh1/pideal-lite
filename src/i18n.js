...
const ar = {
  ...
  'Show details and pay deposit': 'عرض التفاصيل ودفع العربون',
  'Open details to pay the deposit for this order.': 'يلزمك فتح التفاصيل لدفع العربون لهذا الطلب.',
  'Show details and start work': 'عرض التفاصيل وبدء العمل',
  'Open details to start work on this paid order.': 'يلزمك فتح التفاصيل لبدء العمل على هذا الطلب المدفوع.',
  'Show details and submit delivery': 'عرض التفاصيل وإرسال التسليم',
  'Open details to submit the delivery message or link.': 'يلزمك فتح التفاصيل لإرسال رسالة أو رابط التسليم.',
  'Show details and pay remaining': 'عرض التفاصيل ودفع المتبقي',
  'Open details to pay the remaining balance and unlock delivery files.': 'يلزمك فتح التفاصيل لدفع المتبقي وفتح ملفات التسليم.',
  'Show details and review delivery': 'عرض التفاصيل ومراجعة التسليم',
  'Open details to review the delivery and confirm or open a dispute.': 'يلزمك فتح التفاصيل لمراجعة التسليم ثم التأكيد أو فتح نزاع.',
  'Open details to review delivery before the dispute deadline.': 'يلزمك فتح التفاصيل لمراجعة التسليم قبل انتهاء مهلة النزاع.',
  'Review dispute': 'مراجعة النزاع',
  'Review dispute details below, then settle for seller or refund buyer.': 'راجع تفاصيل النزاع أدناه، ثم سوّ للبائع أو استرد للمشتري.',
  ...
  'No admin actions need review right now.': 'لا توجد إجراءات أدمن تحتاج مراجعة الآن.',
  'Open disputes': 'نزاعات مفتوحة',
  'Seller payouts due': 'مدفوعات بائعين مستحقة',
  'Buyer refunds due': 'استردادات مشترين مستحقة',
  'Open reports': 'بلاغات مفتوحة',
  'Order closed. Seller payout completed.': 'تم إنهاء الطلب وتحويل مستحقات البائع.',
  'Order closed. Seller payout is queued for manual transfer.': 'تم إنهاء الطلب ومستحقات البائع بانتظار التحويل اليدوي.',
  'Order closed. Buyer refund is recorded.': 'تم إنهاء الطلب وتسجيل استرداد المشتري.',
  'Previous order': 'طلب سابق',
  'Last order for this service': 'آخر طلب لهذه الخدمة',
  'This previous order is closed. You can request this service again.': 'هذا الطلب السابق مغلق. يمكنك طلب هذه الخدمة مرة أخرى.',
  ...
  'Explain what is wrong with the delivery before admin review': 'اشرح المشكلة في التسليم قبل مراجعة الأدمن',
  'Add a clear reason so admin can review the order fairly.': 'أضف سببًا واضحًا حتى يراجع الأدمن الطلب بعدل.',
  'Add a clear dispute reason before opening admin review.': 'أضف سبب نزاع واضح قبل فتح مراجعة الأدمن.',
  'Dispute review': 'مراجعة النزاع',
  'No dispute reason was recorded for this order.': 'لم يتم تسجيل سبب نزاع لهذا الطلب.',
  'Seller service post': 'منشور خدمة البائع',
  'No service summary available.': 'لا يوجد ملخص خدمة متاح.',
  'No service terms recorded.': 'لا توجد شروط خدمة مسجلة.',
  'No revision policy recorded.': 'لا توجد سياسة تعديلات مسجلة.',
  'No buyer requirements recorded.': 'لا توجد متطلبات مشتري مسجلة.',
  'Buyer request': 'طلب المشتري',
  'No seller delivery message recorded.': 'لا توجد رسالة تسليم من البائع.',
  'Paid by buyer': 'مدفوع من المشتري',
  'Dispute deadline': 'موعد انتهاء النزاع',
