...
export function serializeOrder(order, viewer = null) {
  ...
  return {
    ...
    serviceTerms: order.service?.terms || '',
    serviceRevisionPolicy: order.service?.revisionPolicy || '',
    serviceRequirementsFromBuyer: order.service?.requirementsFromBuyer || '',
    servicePricePi: order.service?.pricePi ?? null,
    serviceDepositPi: order.service?.depositPi ?? null,
    serviceDeliveryDays: order.service?.deliveryDays ?? null,
